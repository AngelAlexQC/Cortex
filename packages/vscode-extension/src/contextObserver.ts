...
export class ContextObserver implements vscode.CodeLensProvider {
  ...
  private initializeDecorations() {
    ...
    this.decorations['debt'] = vscode.window.createTextEditorDecorationType({
      gutterIconPath: vscode.Uri.parse(
        'data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAxNiAxNiIgZmlsbD0iI2Y5NzMxNiI+PHBhdGggZD0iTTggMEw2IDhoNHY4bDItOGgtNHoiLz48L3N2Zz4='
      ),
    ...
    this.decorations['security'] = vscode.window.createTextEditorDecorationType({
      gutterIconPath: vscode.Uri.parse(
        'data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAxNiAxNiIgZmlsbD0iIzYzNjZmMSI+PHBhdGggZD0iTTggMEw2IDhoNHY4bDItOGgtNHoiLz48L3N2Zz4='
      ), // Placeholder icon, would use proper shield
  ...
  private registerListeners() {
    ...
    this.disposables.push(
      vscode.languages.registerCodeLensProvider({ scheme: 'file', language: 'javascript' }, this)
    );
  }
  ...
  public async provideCodeLenses(
    ...
    for (const secMatch of text.matchAll(securityRegex)) {
      if (secMatch.index === undefined) continue;
      const range = new vscode.Range(
